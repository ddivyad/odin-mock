...
@Getter
@Setter
public class OdinOrderHistoryResponse extends OdinBasesResponse {

    @JsonProperty("data")
    private List<OrderData> data = new ArrayList<>(
            List.of(
                    new OrderData(
                            "1111","NSE_EQ",111,"111","1111","1111","cash","it","limit",100,10,110,100,"100","101","1000",10,"TCS","EQ","STK",
                            "","100","","2024-06-05","20204-06-05","ddd","ddd",true,"1000","11",1019010,new BracketDetails(
                                    "111","11","111","121","125","130","1000","111","pending"
                    ))
                    )
    );

    @JsonProperty("metadata")
    private Metadata metadata = new Metadata(100000);
